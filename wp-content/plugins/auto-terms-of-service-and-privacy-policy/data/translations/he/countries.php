...
function wpautoterms_country_translations_he () {
	return json_decode('{
  "AD": "אנדורה", 
  "AE": "איחוד האמירויות", 
  "AF": "אפגניסטן", 
  ...
  "GQ-WN": "Wele-Nzas", 
  "GR": "יוון", 
  "GS": "דרום ג\'ורגיה ואיי דרום סנדביץ\'", 
  "GT": "גואטמלה", 
  "GU": "גואם", 
  "GW": "גינאה ביסאו", 
  "GW-L": "Leste", 
  ...
  "IN-UT": "Uttarakhand", 
  "IN-WB": "West Bengal", 
  "IO": "טריטוריית האוקיאנוס ההודי הבריטית", 
  "IQ": "עירק", 
  "IR": "אירן, הרפובליקה האיסלמית של ", 
  ...
  "UG": "אוגנדה", 
  "UM": "האיים הקטנים מסביב לארצות הברית", 
  ...
  "VE": "ונצואלה, הרפובליקה הבוליוריאנית של", 
  "VE-B": "Anzoátegui", 
  "VE-C": "Apure", 
  "VE-D": "Aragua", 
  "VE-E": "Barinas", 

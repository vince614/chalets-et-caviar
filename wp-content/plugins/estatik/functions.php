...
function es_get_the_content( $post = 0, $more_link_text = null, $strip_teaser = false ) {
    ...
    $post_content = stristr( $post->post_content, '[es_single' ) ? '' : get_the_content( $more_link_text, $strip_teaser );
    return $property->alternative_description ? $property->alternative_description : $post_content;
}

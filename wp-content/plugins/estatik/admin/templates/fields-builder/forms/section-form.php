...
<form action="" method="POST">
    ...
    <input class="es-radio-input" type="radio" id="es-sections-for-<?php echo $name . $i; ?>" <?php checked( $value, Es_FBuilder_Helper::get_settings_value( $instance, 'visible_permission' ) ); ?>
